...
##************************Rabbitmq messaging********************************
# The original notification consumer logic has been moved to
# `app/consumerNotif.py`. The old implementation is commented out
# below to avoid duplicate consumers while keeping the code for
# reference.
#
